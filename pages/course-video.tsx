...
export default function CourseVideoComponent(): ReactElement {
    ...
    const lessonVideoDetails = useAppSelector( state => state?.lessonVideo)

    useEffect(() => {
        actions.getCurrentCourseOutlineDetails()
        // actions.getLessonVideoDetails()
		...
		<Layout>
            <div className="flex flex-row">
                ...
                <div className="-mr-28 pl-28 pt-4 border-t-[1px] border-gray-300 w-[89vw] h-[90vh]">
                    ...
                    <iframe className="mt-8 w-[67.5vw] h-[65vh]" width="560" height="315" src="https://www.youtube.com/embed/eIrMbAQSU34" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" ></iframe>
